...
class Battle5 extends StatefulWidget {
  final String title;
  final Battles battle;

  const Battle5({Key? key, required this.title, required this.battle}) : super(key: key);


  @override
  State<Battle5> createState() => _Battle5();
}

class _Battle5 extends State<Battle5> {
  int _select = 0;
  final List<String> _selections = ['Carnage','Vital Intel', 'Control the Battlefield',
    'Breakthrough', 'Plant the Standard', 'Defiant'];

  void _next() {
    widget.battle.oppSecondary = _selections[_select];
    setState(() {
      Navigator.pushNamed(
          context,
          '/battle6'
