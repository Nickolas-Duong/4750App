...
class Battle8 extends StatefulWidget {
  final String title;
  final Battles battle;
  final int round;
  const Battle8({Key? key, required this.title, required this.battle, required this.round}) : super(key: key);

  @override
  State<Battle8> createState() => _Battle8();
}

class _Battle8 extends State<Battle8> {
  int userVP = 0;
  int oppVP = 0;
  ...
  @override
  void initState() {
    userVP = widget.battle.playerVP1 + widget.battle.playerVP2 + widget.battle.playerVP3;
    oppVP = widget.battle.opponentVP1 + widget.battle.opponentVP2 + widget.battle.opponentVP3;;
  }
  ...
  void _next() {
    ...
    setState(() {
      ...
      widget.battle.opponentVP3 = temp;
  ...
  void updateUserVP() {
    setState((){
      userVP = widget.battle.playerVP1 + widget.battle.playerVP2;
      for (int i = 0; i < userCurrentValues.length; i++){
  ...
  void updateOppVP() {
    setState((){
      oppVP = widget.battle.opponentVP1 + widget.battle.opponentVP2;
      for (int i = 0; i < oppCurrentValues.length; i++){
