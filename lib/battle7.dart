...
class Battle7 extends StatefulWidget {
  final String title;
  final Battles battle;
  final int round;
  const Battle7({Key? key, required this.title, required this.battle, required this.round}) : super(key: key);


  @override
  State<Battle7> createState() => _Battle7();
}

class _Battle7 extends State<Battle7> {
  int userVP = 0;
  int oppVP = 0;
  ...
  void _next() {
    ...
    setState(() {
      ...
      widget.battle.opponentVP2 = temp;
