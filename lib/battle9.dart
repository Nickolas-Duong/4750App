...
class Battle9 extends StatefulWidget {
  final String title;
  final Battles battle;
  final int round;
  const Battle9({Key? key, required this.title, required this.battle, required this.round}) : super(key: key);

  @override
  State<Battle9> createState() => _Battle9();
}

class _Battle9 extends State<Battle9> {
  int userVP = 0;
  int oppVP = 0;
  ...
  @override
  void initState() {
    userVP = widget.battle.playerVP1 + widget.battle.playerVP2 + widget.battle.playerVP3 + widget.battle.playerVP4;
    oppVP = widget.battle.opponentVP1 + widget.battle.opponentVP2 + widget.battle.opponentVP3 + widget.battle.opponentVP4;
  }
  ...
  void _next() {
    ...
    setState(() {
      ...
      widget.battle.opponentVP4 = temp;
